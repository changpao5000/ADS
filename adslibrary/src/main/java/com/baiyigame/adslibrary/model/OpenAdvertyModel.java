...
/**
 * Opening the class advertising advertising information
 * Created by Administrator on 2017/3/15.
 */

public class OpenAdvertyModel extends BaseModel
{
    private int status;// 请求标识
    private String msg ;//返回信息
    private data data; //返回数据
    ...
    public static class data implements Serializable
    {
        ...
        private int ac;// int 1 广告数量
        private int ss ;//int 5秒 广告切换时间
        private int aot ;//int 1秒 自动关闭时间
        ...
        public static class style implements Serializable
        {
            ...
            public OpenAdvertyModel.data.style.b getB() {
                return b;
            }

            public void setB(OpenAdvertyModel.data.style.b b) {
                this.b = b;
            }

            public OpenAdvertyModel.data.style.c getC() {
                return c;
            }

            public void setC(OpenAdvertyModel.data.style.c c) {
                this.c = c;
            }

            public OpenAdvertyModel.data.style.i getI() {
                return i;
            }

            public void setI(OpenAdvertyModel.data.style.i i) {
                this.i = i;
            }

            public OpenAdvertyModel.data.style.l getL() {
                return l;
            }

            public void setL(OpenAdvertyModel.data.style.l l) {
                this.l = l;
            }

            public OpenAdvertyModel.data.style.t getT() {
                return t;
            }

            public void setT(OpenAdvertyModel.data.style.t t) {
                this.t = t;
            }
        ...
        public OpenAdvertyModel.data.style getStyle() {
            return style;
        }

        public void setStyle(OpenAdvertyModel.data.style style) {
            this.style = style;
        }
    ...
    public OpenAdvertyModel.data getData() {
        return data;
    }

    public void setData(OpenAdvertyModel.data data) {
        this.data = data;
    }

    @Override
    public String toString() {
        return "OpenAdvertyModel{" +
                "status=" + status +
                ", msg='" + msg + '\'' +
                ", data=" + data +
                '}';
