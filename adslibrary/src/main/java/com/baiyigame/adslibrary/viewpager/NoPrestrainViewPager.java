 ...
 */
public class NoPrestrainViewPager extends ViewGroup
{
    private static final String TAG = NoPrestrainViewPager.class.getSimpleName();
    ...
    public interface OnPageChangeListener
    {
        ...
        /**
         * When the current page in the first page of sliding forward or to continue sliding backwards in the last page isLastPageScroll is true,
         * false otherwise
         * @param isLastPageScroll
         */
    ...
    public NoPrestrainViewPager(Context context)
    {
        super(context);
        initViewPager();
    }

    public NoPrestrainViewPager(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        initViewPager();
    }
        ...
        switch (action)
        {
            case MotionEvent.ACTION_MOVE:
            {
                ...
                */
                ...
                if (DEBUG)Log.e(TAG,"atEdge-------------------------------------------->"+atEdge);
                if (mOnPageChangeListener != null)
                {
                    mOnPageChangeListener.onPageIsLastScroll(atEdge);
                }
