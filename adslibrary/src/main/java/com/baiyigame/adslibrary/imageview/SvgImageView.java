package com.baiyigame.adslibrary.imageview;
...
import com.baiyigame.adslibrary.imageview.svgandroid.SVGParser;
...
public class SvgImageView extends BaseImageView
{
    ...
    public static Bitmap getBitmap(Context context, int width, int height, int svgRawResourceId)
    {
        ...
        {
            com.baiyigame.adslibrary.imageview.svgandroid.SVG svg = SVGParser.getSVGFromInputStream(
