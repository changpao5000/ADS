 ...
 * Basically, if BYGson is created with a version number that exceeds the value stored in the
 ...
 * BYGson with {@code BYGson gson = new GsonBuilder().setVersion(1.2).create()} then the
 * {@code toJson()} and {@code fromJson()} methods of BYGson will exclude the {@code emailAddress}
