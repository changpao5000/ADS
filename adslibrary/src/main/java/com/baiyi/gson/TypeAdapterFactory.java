 ...
 * multiset's type token. A {@code BYGson} is passed in to {@code create} for
 ...
 * the foundation of how BYGson converts Java objects and collections. Whenever
...
public interface TypeAdapterFactory {
	 ...
	 * support {@code type}.
	 */
	<T> TypeAdapter<T> create(BYGson gson, TypeToken<T> type);
}